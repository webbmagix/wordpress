...
Text Domain: wmgx4-product-key-validation
*/

defined( 'ABSPATH' ) or die( 'No script kiddies please!' );

//require_once(plugins_url( '/wmgx4-product-key-validation.php', __FILE__ ));
require_once(plugin_dir_path(__FILE__) .  'wmgx4-product-key-validation.php');
...
function ajax_enqueue_scripts() {
  // alternate: plugin_dir_url( __FILE__ ) . 'wmgx2-product-key-validation.js')
	wp_enqueue_script( 'wmgx_key_management', plugins_url( '/wmgx4-product-key-management.js', __FILE__ ), array(
    'jquery'));
